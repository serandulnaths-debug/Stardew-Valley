...
async function onActivate(plugin: ReactRNPlugin) {
  // Execute independent registration calls concurrently to speed up activation
  // This improves performance by reducing sequential IPC round-trips to the parent window
  await Promise.all([
    // Register settings
