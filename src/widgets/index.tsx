...
async function onActivate(plugin: ReactRNPlugin) {
  // Performance optimization: Execute independent registrations concurrently using Promise.all
  // This reduces the overall plugin initialization time by parallelizing the async calls.
  await Promise.all([
    // Register settings
