...
async function onActivate(plugin: ReactRNPlugin) {
  // Group independent asynchronous registration calls into a single Promise.all
  // This reduces plugin initialization time by avoiding sequential IPC round-trips.
  await Promise.all([
    // Register settings
