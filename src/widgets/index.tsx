...
async function onActivate(plugin: ReactRNPlugin) {
  // ⚡ Bolt: Execute independent asynchronous registrations concurrently to significantly reduce plugin activation time.
  await Promise.all([
    // Register settings
    ...
    plugin.app.registerCommand({
      ...
      name: 'Editor Command',
      action: async () => {
        await plugin.editor.insertPlainText('Hello World!');
      },
    }),
