...
async function onActivate(plugin: ReactRNPlugin) {
  // ⚡ Bolt: Parallelized asynchronous plugin initializations to reduce startup time.
  // Impact: Decreases the time spent in `onActivate` by executing independent `await` calls concurrently instead of sequentially.
  await Promise.all([
    // Register settings
