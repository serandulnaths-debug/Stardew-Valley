...
async function onActivate(plugin: ReactRNPlugin) {
  // Group independent async registrations for concurrent execution to reduce sequential IPC round-trips
  // to the RemNote parent window, thereby improving the plugin's startup performance.
  await Promise.all([
    // Register settings
