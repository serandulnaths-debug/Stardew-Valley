...
async function onActivate(plugin: ReactRNPlugin) {
  // Optimization: Use Promise.all to execute independent plugin registrations concurrently,
  // avoiding sequential blocking IPC round-trips to the parent window.
  await Promise.all([
    // Register settings
