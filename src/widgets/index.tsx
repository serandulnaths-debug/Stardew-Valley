...
async function onActivate(plugin: ReactRNPlugin) {
  // ⚡ Bolt: Run independent plugin registrations concurrently using Promise.all()
  // Expected Impact: Reduces plugin startup time since these asynchronous
  // setup calls no longer block each other.
  await Promise.all([
    // Register settings
