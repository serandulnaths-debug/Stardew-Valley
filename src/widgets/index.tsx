...
async function onActivate(plugin: ReactRNPlugin) {
  // ⚡ Bolt: Optimize plugin activation by registering independent settings and widgets concurrently
  // This reduces overall plugin loading time by avoiding sequential network/bridge calls
  await Promise.all([
    // Register settings
