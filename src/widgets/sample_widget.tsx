...
export const SampleWidget = () => {
  ...
  return (
    <section
      ...
      className="p-3 m-2 rounded-lg rn-clr-background-light-positive rn-clr-content-positive shadow-sm"
    >
      <h1 className="text-xl font-semibold mb-2">Sample Plugin</h1>
      <p className="text-sm">
        Hi <span className="font-medium">{name || 'User'}</span>, you {likesPizza ? 'do' : "don't"} like pizza and your favorite number is{' '}
