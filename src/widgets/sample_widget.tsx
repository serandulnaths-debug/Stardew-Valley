...
export const SampleWidget = () => {
  ...
  const name = useTrackerPlugin(() => plugin.settings.getSetting<string>('name'));
  const likesPizza = useTrackerPlugin(() => plugin.settings.getSetting<boolean>('pizza'));
  const favoriteNumber = useTrackerPlugin(() => plugin.settings.getSetting<number>('favorite-number'));
