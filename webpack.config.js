...
const validWidgets = Object.keys(entryPoints).filter(k => !k.endsWith(SANDBOX_SUFFIX));
...
const config = {
  ...
  plugins: [
    ...
    new HtmlWebpackPlugin({
      ...
      // 🛡️ Security: Validate widgetName against an allowlist to prevent DOM XSS and malicious script injection
